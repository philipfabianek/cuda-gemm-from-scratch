...
int verify_on_cpu(int M, int K, int N, float alpha, const std::vector<float> &A, const std::vector<float> &B, float beta, const std::vector<float> &C_initial, const std::vector<float> &C_result)
{
